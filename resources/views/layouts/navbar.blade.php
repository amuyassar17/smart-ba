<nav class="navbar navbar-expand-lg navbar-dark sticky-top">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center py-2" href="{{ route('home') }}">
            <img src="{{ asset('images/logo-uin-palopo.png') }}" alt="Logo UIN Palopo" style="height: 50px; margin-right: 12px;">
            <div>
                <div class="fw-bold" style="font-size: 1rem; line-height: 1.2;">SMART-BA Fakultas Syariah dan Hukum</div>
                <div style="font-size: 0.7rem; opacity: 0.85; font-weight: 400;">Universitas Islam Negeri Kota Palopo</div>
            </div>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                @guest('dosen')
                    <li class="nav-item">
                        <a class="nav-link px-3 fw-semibold" href="{{ route('home') }}">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="{{ route('home') }}#profil">Profil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="{{ route('home') }}#fasilitas">Fasilitas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="{{ route('home') }}#kontak">Kontak</a>
                    </li>
                    <li class="nav-item ms-lg-2">
                        <a class="btn btn-light btn-sm px-4 py-2" href="{{ route('login') }}" style="border-radius: 25px; font-weight: 600;">
                            Login
                        </a>
                    </li>
                @endguest
